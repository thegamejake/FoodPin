    ...
    struct BasicTextImageRow: View {
        ...
        var body: some View {
            ...
            .confirmationDialog("有什麼可以幫到你？", isPresented: $showOptions, titleVisibility: .visible) {
                
                Button("我要預訂") {
                    self.showError.toggle()
                }
                
                Button(restaurant.isFavorite ? "移除我的最愛" : "我的最愛") {
                    self.restaurant.isFavorite.toggle()
                }
            }
            .alert("尚不可用", isPresented: $showError) {
                Button("OK") {}
            } message: {
                Text("抱歉，此功能尚不可用。 請稍後重試。")
            }
            */
            ...
            .contextMenu {
                ...
                Button(action: {
                    ...
                    HStack {
                        Text(restaurant.isFavorite ? "移除我的最愛" : "我的最愛")
                        Image(systemName: "heart")
                    }
                }
